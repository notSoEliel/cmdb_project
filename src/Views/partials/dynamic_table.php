                            ...
                            <tr>
                                ...
                                <td class="text-end text-nowrap sticky-col last-col">
                                    <?php if ($currentRoute === 'inventario') : ?>
                                        <?php // Si el equipo TIENE una asignación activa (independiente del estado)... 
                                        ?>
                                        <?php if (!empty($row['asignacion_id'])) : ?>
                                            <form action="?route=inventario&action=unassign" method="POST" class="d-inline form-delete">
                                            ...
                                            <?php // Si NO tiene asignación Y su estado es 'En Stock', se puede asignar. 
                                            ?>
                                        <?php elseif ($row['estado'] === 'En Stock') : ?>
                                    ...
                                    <?php $editParams = array_merge($queryParams, ['editar_id' => $row['id']]); ?>
                                    ...
                                    <form action="?route=<?= $actions['delete_route'] ?>" method="POST" class="d-inline form-delete">
                                        <input type="hidden" name="id" value="<?= $row['id'] ?>"><button type="submit" class="btn btn-sm btn-danger" title="Eliminar"><i class="bi bi-trash-fill"></i></button>
                                    </form>
                                </td>
                            </tr>
                    <?php endforeach;
